...
export const en = {
  ...
  onboardingDescription: 'Add a provider and API key in Settings to start chatting.',
  onboardingLater: 'Configure later',
  onboardingOpen: 'Open Settings',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingTitle: '配置模型即可开始使用',
  onboardingDescription: '在设置中添加一个提供方和 API 密钥，即可开始对话。',
