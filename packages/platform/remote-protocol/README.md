...
- The current Companion catalog proves prompt submission, attachment offers, authoritative Session search, operation-status query, transcript and foreground synchronization projections, and the confirmed, attachment-rejected, session-search, operation-failed, and status result kinds; discovery, creation, interaction, and cancellation messages require later protocol additions before their adapters can expose them.
