...
describe('Companion product-entry purity gate', () => {
  ...
  it('does not promote a type-only barrel cycle into a runtime product dependency', () => {
    const root = fixtureRoot({
      'apps/desktop/src/main.ts': "import { productProvider } from './provider.ts'\nvoid productProvider\n",
      'apps/desktop/src/provider.ts': [
        "import type { FixtureState } from './test-fixture.ts'",
        'export const productProvider = {} as FixtureState',
        '',
      ].join('\n'),
      'apps/desktop/src/test-fixture.ts': [
        "import type { productProvider } from './provider.ts'",
        "export interface FixtureState { provider?: typeof productProvider; nested?: import('./provider.ts').FixtureState }",
        'export class MemoryAccountBackend {}',
        '',
      ].join('\n'),
      'apps/mobile/src/main.tsx': '',
      'apps/platform/src/boot.ts': '',
