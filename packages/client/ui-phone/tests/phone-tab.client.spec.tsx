 ...
 * injected source, the USB placeholder follows its group, and re-detect
 * stays a disabled placeholder in this skeleton.
 */
...
describe('PhoneTab empty state', () => {
  it('renders the gated empty state when disabled', () => {
    render(<PhoneTab enabled={false} source={sourceWith([])} />)
  ...
  it('omits the gate strip once enabled', () => {
    render(<PhoneTab enabled={true} source={sourceWith([])} />)
  ...
  it('lists devices of both groups straight from the injected source', () => {
    ...
    render(<PhoneTab enabled={true} source={sourceWith(devices)} />)
  ...
  it('relists devices when the platform switches', () => {
    ...
    render(<PhoneTab enabled={true} source={source} />)
