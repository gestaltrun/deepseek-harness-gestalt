 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-platform-account\/privacy|@deepseek-ai\/dsh-browser-workspace\/client$|@deepseek-ai\/dsh-(?:host-apiproxy|file-reference|session|llm|tools|brand)(?:\/|$))/
