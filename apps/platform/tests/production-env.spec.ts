...
describe('Platform release workflows', () => {
  ...
  it('validates Environment production without applying ECS unless deploy is set', () => {
    ...
    expect(applySource).toContain('export OSS_ACCESS_KEY_ID="$ALIBABA_CLOUD_ACCESS_KEY_ID"')
    expect(applySource).toContain('export OSS_ACCESS_KEY_SECRET="$ALIBABA_CLOUD_ACCESS_KEY_SECRET"')
    expect(applySource).toContain('export OSS_SESSION_TOKEN="$ALIBABA_CLOUD_SECURITY_TOKEN"')
    ...
    expect(recoverWorkflowSource).toContain('export OSS_ACCESS_KEY_ID="$ALIBABA_CLOUD_ACCESS_KEY_ID"')
    expect(recoverWorkflowSource).toContain('export OSS_ACCESS_KEY_SECRET="$ALIBABA_CLOUD_ACCESS_KEY_SECRET"')
    expect(recoverWorkflowSource).toContain('export OSS_SESSION_TOKEN="$ALIBABA_CLOUD_SECURITY_TOKEN"')
    expect(recoverWorkflowSource).toContain('bash apps/platform/scripts/platform-recover.sh')
