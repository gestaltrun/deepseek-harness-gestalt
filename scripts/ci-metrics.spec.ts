  ...
  it('excludes aggregate, observational, cancelled, skipped, and superseded samples', () => {
    const metrics = computeCiMetrics([
      run(1, 'success', [
        ...
        job('windows node 24 / native coverage exempt-heavy', 'failure', '2026-08-24T00:00:02.000Z', '2026-08-24T00:01:00.000Z'),
    ...
    expect(metrics).toMatchObject({
      ...
      successfulRuns: 1,
      successRate: 1,
      queueMs: { p50: 2000, p95: 2000, max: 2000 },
      executionMs: { p50: 13000, p95: 13000, max: 13000 },
      firstConclusionMs: { p50: 5000, p95: 5000, max: 5000 },
      includedRunIds: [1],
