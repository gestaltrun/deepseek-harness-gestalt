...
| [phone-runtime.md](phone-runtime.md) | the phone device fleet seam: the folded mobilecli Service, loopback server lifecycle, health polling, the grouped Android/iOS listing on `ctx.phoneDevices`, and the deferred tool Consumer |
