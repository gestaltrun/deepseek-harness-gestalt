...
export const zh = {
  ...
  'sub2api.restartStart': '重启 Web Host 并启动',
  'sub2api.starting': '正在启动本机组件（首次启动需初始化数据库，可能需要数分钟）…',
  'sub2api.running': '运行中',
  'sub2api.openConsole': '打开账号台',
  'sub2api.closeConsole': '关闭账号台',
...
export const en = {
  ...
  'sub2api.restartStart': 'Restart Web Host and start',
  ...
  'sub2api.openConsole': 'Open account console',
  'sub2api.closeConsole': 'Close account console',
