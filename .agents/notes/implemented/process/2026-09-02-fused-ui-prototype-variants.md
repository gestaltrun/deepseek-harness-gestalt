...
Prototype branches stay planning input, not production history. Implementation tickets rewrite the winning variant against tests and lifecycle rules. Specs cite a frozen draft instead of restating layout. Coordinating sessions stay smaller because they do not host the drawing loop.
