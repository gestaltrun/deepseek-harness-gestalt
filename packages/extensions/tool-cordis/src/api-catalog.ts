  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Execute one semantic tap, swipe, text, or button action. Android coordinate actions retain their pixels. iOS obtains cached portrait `device.info` bounds and projects every displayed endpoint through exact rotation; browser actions bind current capture identity and model actions use a bounded fresh MJPEG EXIF probe. Physical handsets are valid targets; only ids absent from the latest published listing fail locally before any RPC.',
