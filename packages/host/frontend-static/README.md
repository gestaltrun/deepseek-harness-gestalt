...
- **The MIME table follows shipped asset classes.** Extensions outside the Web build, PWA manifest, and crawler-discovery files fall back to `application/octet-stream` until an application needs them.
