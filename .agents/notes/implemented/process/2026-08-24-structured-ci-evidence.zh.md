...
2026-08-24 基线查询了最近 20 次主 CI run。run 32667140424、32666575103 和 32665585148 是有效样本：成功率为 66.7%；排队 p50/p95 为 11/24 秒；执行 p50/p95 为 691/718 秒；首个有效结论 p50/p95 为 22/43 秒。较小的有效样本量作为此前取消和 supersession 噪声的证据被保留，不会用无效样本补齐。
