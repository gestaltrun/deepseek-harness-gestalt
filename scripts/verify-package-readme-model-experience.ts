...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-better-sidebar': { kind: 'indirect', reason: 'Optional snapshot terminal_* tools stay behind a Side Card setting; this README does not own those schemas.' },
